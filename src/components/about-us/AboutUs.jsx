      ...
      <section className={styles.bioWrapper}>
        <div className={styles.bioContainer}>
          <section>
            ...
            <a href="https://github.com/katiepdx" target="_blank" rel="noreferrer"><img src={githubIcon} alt="github icon" height="30px" width="30px" /></a>
            <a href="https://www.linkedin.com/in/katiepdx/" target="_blank" rel="noreferrer"><img src={linkedinIcon} alt="github icon" height="30px" width="30px" /></a>
          </section>
        </div>
        ...
        <div className={styles.bioContainer}>
          <section>
            ...
            <a href="https://github.com/gregmall" target="_blank" rel="noreferrer"><img src={githubIcon} alt="github icon" height="30px" width="30px" /></a>
            <a href="https://www.linkedin.com/in/greg-mall-3032771b1/" target="_blank" rel="noreferrer"><img src={linkedinIcon} alt="github icon" height="30px" width="30px" /></a>
          </section>
        </div>
        ...
        <div className={styles.bioContainer}>
          <section>
            ...
            <a href="https://github.com/Thomas-Stussi" target="_blank" rel="noreferrer"><img src={githubIcon} alt="github icon" height="30px" width="30px" /></a>
            <a href="https://www.linkedin.com/in/thomas-stussi/" target="_blank" rel="noreferrer"><img src={linkedinIcon} alt="github icon" height="30px" width="30px" /></a>
          </section>
        </div>
        ...
        <div className={styles.bioContainer}>
          <section>
            ...
            <a href="https://github.com/benwaples" target="_blank" rel="noreferrer"><img src={githubIcon} alt="github icon" height="30px" width="30px" /></a>
            <a href="https://www.linkedin.com/in/benwaples/" target="_blank" rel="noreferrer"><img src={linkedinIcon} alt="github icon" height="30px" width="30px" /></a>
          </section>
        </div>
      </section>
    </section>
